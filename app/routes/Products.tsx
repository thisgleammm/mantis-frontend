...
export default function Products() {
  ...
  return (
    <div className="min-h-screen px-6 py-8 font-sans bg-gray-50 text-black dark:bg-black dark:text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-7 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{filtered.length} produk tersedia</p>
          </div>
